"""
Django settings for plannerproject project.
...
SECRET_KEY = 'django-insecure-e)eb#n-b7mgma5krdl-ka(ca#mr8(7!z*ipt^zd4lb6hwk^k39'
...
ROOT_URLCONF = 'plannerproject.urls'
...
WSGI_APPLICATION = 'plannerproject.wsgi.application'
